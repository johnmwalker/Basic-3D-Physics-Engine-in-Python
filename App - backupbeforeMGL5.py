...
class App(object):
    ...
    def initializeModernGL(self):
        ...
        self.prog.uniforms['textures'].value = [0,1]
...
#        self.light.value = (0,0,0) #-140.0, -300.0, 350.0
        ...
        # charge of rendering.
        vao_content = [(cubeVertBuffer,    '3f2f', ['in_vert_c', 'in_text_c']),
                       (sphereVertBuffer,  '3f2f', ['in_vert_s', 'in_text_s',]),
                       (self.entityBuffer, '3f9f3f1f1i/i', ['in_pos',
